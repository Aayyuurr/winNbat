...
export const load = (async (event) => {
	...
	const RegisterSchema =  z.object({
		...
		username: z.string().min(3,ll.registerSchema.usernameIshort()).max(100,ll.registerSchema.usernameTooLong()),
		confirm_password: z.string().min(8,ll.ShortPassword()).max(100,ll.PasswordTooLong()),
		birthdate: z.string().min(8,ll.registerSchema.birthdateRequired()).max(100,ll.registerSchema.birthdateRequired()),
